...
if ( ! class_exists( 'Insign_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Insign 1.0
	 */
	class Insign_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'insign' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'insign' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'insign' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'insign' ),
						'full'    => esc_html__( 'Full text', 'insign' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-insign-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Insign_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Insign_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'insign' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
