/* global insignIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'insign-supports-dark-theme' ) ) {
	insignDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function insignDarkModeEditorInit( attempt ) {
	...
	if ( insignIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						insignDarkModeEditorInit( attempt + 1 );
					},
